...
Read documents on demand according to the task.
...
| [Failure Index](./failure-index.md) | Searchable pointers to known failures. |
| [Execution Log](./execution-log.md) | Completed work with reusable learning. |
| [Memory](./memory.json) | Machine-readable stable constraints and recurring failures. |

Always start with the root `AGENTS.md`. Do not read every document by default.
